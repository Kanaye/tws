...
export type ChannelMessageTagKeys = "badges" | "bits" | "color" | "display-name" | "emotes" | "id" | "message" | "mod" | "room-id" | "subscriber" | "tmi-sent-ts" | "turbo" | "user-id" | "user-type";
...
export type UserNoticeTagKeys = "badges" | "color" | "display-name" | "emotes" | "id" | "login" | "message" | "mod" | "msg-id" | "msg-param-displayName" | "msg-param-login" | "msg-param-months" | "msg-param-recipient-display-name" | "msg-param-recipient-id" | "msg-param-recipient-user-name" | "msg-param-sub-plan" | "msg-param-sub-plan-name" | "msg-param-viewerCount" | "msg-param-ritual-name" | "room-id" | "subscriber" | "system-msg" | "tmi-sent-ts" | "turbo" | "user-id" | "user-type";
...
export type GlobalUserStateTagKeys = "badges" | "color" | "display-name" | "emote-sets" | "turbo" | "user-id" | "user-type";
